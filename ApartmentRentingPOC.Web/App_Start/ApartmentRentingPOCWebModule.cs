...
namespace ApartmentRentingPOC.Web
{
    [DependsOn(
        ...
        typeof(ApartmentRentingPOCWebApiModule))]
    public class ApartmentRentingPOCWebModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Localization.Sources.Add(
                new DictionaryBasedLocalizationSource(
                    ApartmentRentingPOCConsts.LocalizationSourceName,
                    new XmlFileLocalizationDictionaryProvider(
                        HttpContext.Current.Server.MapPath("~/Localization/ApartmentRentingPOC")
                        )
                    )
                );

            //Configure navigation/menu
            Configuration.Navigation.Providers.Add<ApartmentRentingPOCNavigationProvider>();
        }
